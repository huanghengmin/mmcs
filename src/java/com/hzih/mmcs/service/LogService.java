...
import com.hzih.mmcs.domain.EquipmentLog;
...
public interface LogService {
     ...
     * @param auditInfo
     */
	public void newLog(String level, String userName, String auditModule, String auditInfo)throws Exception;
     ...
     * @throws Exception
     */
    public void newLog(EquipmentLog equipmentLog)throws Exception;

    public void newEquipmentLog(EquipmentLog equipmentLog)throws Exception;

    public void newSysLog(String level, String auditModule, String auditAction, String auditinfo)throws Exception;
}
