...
Ext.onReady(function() {
    ...
    var record = new Ext.data.Record.create([
        {name:'id',			mapping:'id'},
        {name:'auditAction',		mapping:'auditAction'},
    ...
    var proxy = new Ext.data.HttpProxy({
        url:'../../AuditAction_selectOSAudit.action'
    });
    ...
    var colM = new Ext.grid.ColumnModel([
        boxM,
        rowNumber,
        {header:'审计时间',		dataIndex:'logTime',		   align:'center',sortable:true,menuDisabled:true,width:120},
        {header:"日志等级",		dataIndex:"level",	       align:'center',sortable:true,menuDisabled:true,width:50},
        {header:"审计行为",		dataIndex:"auditAction",       align:'center',sortable:true,menuDisabled:true,width:100},
        {header:'审计模块',	    dataIndex:'auditModule',	   align:'center',sortable:true,menuDisabled:true,width:100},
