...
//        boxM,
        ...
        {header:"日志等级",		dataIndex:"level",	       align:'center',sortable:true,width:50},
        {header:'用户名 ',			dataIndex:"userName",       align:'center',sortable:true,width:100 },
        {header:'审计模块',	    dataIndex:'auditModule',	   align:'center',sortable:true,width:100},
        {header:'审计信息',	    dataIndex:'auditInfo',      align:'center',sortable:true}
