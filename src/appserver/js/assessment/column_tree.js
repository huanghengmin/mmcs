...
//        title: '考核评比',
        columns:[
            {header: "地区",align:'center', sortable: true, dataIndex: 'address',width:Ext.getBody().getWidth()/7+253},
            {header: "注册信息得分", align:'center', sortable: true, dataIndex: 'reg_score',width:Ext.getBody().getWidth()/7-50},
            {header: "违规处理得分",align:'center', sortable: true, dataIndex: 'abn_score',width:Ext.getBody().getWidth()/7-50},
            {header: "管理员登陆情况得分", align:'center', sortable: true, dataIndex: 'log_score',width:Ext.getBody().getWidth()/7-20},
            {header: "系统巡检情况得分", align:'center', sortable: true,dataIndex: 'ins_score',width:Ext.getBody().getWidth()/7-30},
            {header: "系统活跃情况得分",align:'center', sortable: true,dataIndex: 'act_score',width:Ext.getBody().getWidth()/7-30} ,
            {header: "总分",align:'center', sortable: true,dataIndex: 'sum_score',width:Ext.getBody().getWidth()/7-90}/*,
...
function show_system_score(node){
    var cm = new Ext.grid.ColumnModel([
        {header:'系统', dataIndex:'address'},
        {header:'注册信息得分', dataIndex:'reg_score'},
        {header:'违规处理得分', dataIndex:'abn_score'},
        {header:'管理员登陆情况得分', dataIndex:'log_score'},
        {header:'系统巡检情况得分', dataIndex:'ins_score'},
        {header:'系统活跃情况得分', dataIndex:'act_score'},
        {header:'总分', dataIndex:'sum_score'}
    ]);
